const RELEASE='20260710-writing';
const CACHE_NAME='eiken-vocab-v2-'+RELEASE;
const ASSETS=['./','./index.html?v='+RELEASE,'./style.css?v='+RELEASE,'./writing.css?v='+RELEASE,'./words.js?v='+RELEASE,'./writing.js?v='+RELEASE,'./app.js?v='+RELEASE,'./manifest.webmanifest?v='+RELEASE,'./icon.svg?v='+RELEASE];
